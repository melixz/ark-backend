...
class PageAPIView(APIView):
    ...
    def get(self, request, format=None):
        ...
        section_two_serializer = SectionTwoSerializer(
            section2, context={"request": request}
        )
        section_three_serializer = SectionThreeSerializer(
            section3, context={"request": request}
        )
